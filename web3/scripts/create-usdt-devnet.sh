#!/bin/bash
# Script to create a USDT mint on devnet and mint tokens to your wallet

set -e

echo "🪙 Creating USDT Mint on Devnet"
echo "================================="
echo ""
...
echo ""
echo "4. Or they can use your mint address in the frontend config"
echo ""
