...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-card border-b border-border inline-flex h-9 w-fit items-center justify-center rounded-none p-0 gap-0",
        className
      )}
      {...props}
    />
